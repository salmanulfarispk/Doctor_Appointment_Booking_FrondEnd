...
const Footer = () => {
  ...
  <div className="mx-auto max-w-5xl justify-center text-center flex flex-col items-center px-4 py-16 sm:px-6 lg:px-8">
   ...
   />
    ...
    Discover the ease of managing your healthcare appointments with DocTimepro. Our platform offers seamless booking for doctor appointments, ensuring you get the care you need, when you need it. With DocTimepro, your journey to better health begins with just a few clicks. Trust DocTimepro for
      appointment scheduling and expert medical care.
    </p>
